...
import org.evosuite.ga.metaheuristics.LandscapeAnalysis.RandomWalkBasedTestCase;
...
public class PropertiesSuiteGAFactory extends PropertiesSearchAlgorithmFactory<TestSuiteChromosome> {
	...
	protected GeneticAlgorithm<TestSuiteChromosome> getGeneticAlgorithm(ChromosomeFactory<TestSuiteChromosome> factory) {
		switch (Properties.ALGORITHM) {
			...
			case RANDOM_WALK_TC:
				logger.info("Chosen search algorithm: Random walk (Test case representation)");
				{
					return new RandomWalkBasedTestCase<TestSuiteChromosome>(factory);
				}
			default:
